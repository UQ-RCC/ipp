...
angular.module('microvolution.files-manager', ['ngRoute', 'ngResource'])
    ...
    .controller('FilesManagerCtrl', ['$scope', '$interval', 
        ...
        function ($scope, $interval, 
            ...
            //refresh experiment
            var filesListRefreshTimer, lastPaths, userPref;
                ...
                UserPreferenceFactory.get().$promise.then(
                    function (data) {
                        ...
                        if(userPref.hasOwnProperty("bookmark"))
                            $scope.filesmanagerOptions.shortcuts = userPref["bookmark"];
                        else
            ...
            */
            $scope.addShortcut = function (shortcutPath) {
                ...
                userPref['bookmark'] = $scope.filesmanagerOptions.shortcuts
                UserPreferenceFactory.update({}, angular.toJson(userPref));
            };
